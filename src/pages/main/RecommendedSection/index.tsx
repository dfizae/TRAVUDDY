...
export default function RecommendedSection() {
    ...
    const recommendedData = [
        {image: '../../../../public/images/pics/RecommendedLukas.svg', alt: 'Lukas 프로필', name: "Lukas", location: "Korea, Seoul", star_rate: 4.6, hashtag_1: '#Dog_Lover', hashtag_2: '#Car'},
        {image: '../../../../public/images/pics/RecommendedJiwon.svg', alt: 'Jiwon 프로필', name: "Ji-won", location: "Korea, Jeju", star_rate: 4.6, hashtag_1: '#Kids_Specialist', hashtag_2: '#Local Foodie'},
        {image: '../../../../public/images/pics/RecommendedSarah.svg', alt: 'Sarah 프로필', name: "Sarah", location: "Korea, Busan", star_rate: 4.6, hashtag_1: '#Expat_Life', hashtag_2: '#Hiking'},
    ];
