export default function Rate({ rateNum }: { rateNum: number }) {
    return (
        <>
            <div className="w-fit flex items-center justify-center gap-1 px-1.5 py-0.5 border border-[#D95500] rounded-full bg-white">
                ...
                <span className="text-[#D95500] font-semibold text-xs">{rateNum.toFixed(1)}</span>
